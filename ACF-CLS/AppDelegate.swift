...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let barTintColor: UIColor = UIColor(red: 51/255.0, green: 106/255.0, blue: 144/255.0, alpha: 1.0)
        ...
        //toolBarAppearace.barStyle = UIBarStyle.BlackTranslucent
        toolBarAppearance.barTintColor = barTintColor
        toolBarAppearance.tintColor = UIColor.whiteColor()
        
        tabBarAppearance.barStyle = UIBarStyle.Default
        tabBarAppearance.tintColor = barTintColor
        
        tabBarItemAppearance.setTitleTextAttributes([NSForegroundColorAttributeName: barTintColor], forState:.Normal)
        tabBarItemAppearance.setTitleTextAttributes([NSForegroundColorAttributeName: barTintColor], forState:.Selected)
    ...
    func application(application: UIApplication, didRegisterUserNotificationSettings notificationSettings: UIUserNotificationSettings){
        /*
        if notificationSettings.types.rawValue & UIUserNotificationType.Alert.rawValue == 0 {
            var alertView:UIAlertView = UIAlertView()
            alertView.message = "Please allow notifications in settings to receive alerts."
    ...
    func application(application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: NSData) {
        ...
        //NSLog("AppDelegate My token is: \(tokenString)")
    }
    ...
    func application(application: UIApplication, didReceiveRemoteNotification userInfo: [NSObject : AnyObject]) {
        //println("notification is: \(userInfo)")
        ...
        if (application.applicationState == UIApplicationState.Background || application.applicationState == UIApplicationState.Inactive){
            SharedClass().homePage(self.window!)
        }
        else{
            if(activeViewController.isKindOfClass(HomeViewController)){
                NSNotificationCenter.defaultCenter().postNotificationName("updateBadge", object: nil)
            }/*
            else{
            var refreshAlert = UIAlertController(title: "", message: "You have \(badgeNumber) new notification(s).", preferredStyle: UIAlertControllerStyle.Alert)
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.acistek.ACF_CLS" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("ACF_CLS", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("ACF_CLS.sqlite")
